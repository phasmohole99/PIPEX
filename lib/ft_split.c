...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/22 04:31:37 by mrital-           #+#    #+#             */
/*   Updated: 2022/10/23 07:13:49 by mrital-          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// aykhssni ndir function tan9z lia keys li bin strings // aykhssni nhssb string
...
char	**ft_split(char const *s, char c)
{
	...
	new = malloc((len_jump((char *)s, c) + 1) * sizeof(char *));
	if (!new)
		return (NULL);
	p = 0;
	a = 0;
